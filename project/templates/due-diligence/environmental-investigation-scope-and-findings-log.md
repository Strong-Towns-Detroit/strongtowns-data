...
artifact_id: DD-015
artifact_type: log
title: Environmental investigation scope and findings log
...
required_reviewer_role: environmental_professional
...
# Environmental investigation scope and findings log

`DD-015` · due-diligence · service code `LND`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Scopes environmental investigation and logs findings. On Detroit infill land, prior use is the dominant risk.

## When to use it

Before any offer becomes unconditional.
...
- Scope to the parcel's actual history, not to a generic checklist.
- A Phase I that finds nothing is not a clean site; it is a site with no recognised conditions identified by that method.
...
- **Required reviewer: `environmental_professional`.** Record the review in `GOV-015` before this artifact is relied on at a gate.
