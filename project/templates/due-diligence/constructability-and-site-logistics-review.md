...
title: Constructability and site-logistics review
...
# Constructability and site-logistics review

`DD-023` · due-diligence · service code `EST`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Reviews whether the site can actually be built on efficiently — access, staging, storage, neighbouring constraints. ICA Exhibit A assigns constructability review before permit submission.
...
- This is a Contractor deliverable under Exhibit A. Perform it before the design is frozen, when it can still change the outcome.
