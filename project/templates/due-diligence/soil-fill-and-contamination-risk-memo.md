...
artifact_id: DD-017
artifact_type: memo
title: Soil, fill and contamination risk memo
...
# Soil, fill and contamination risk memo

`DD-017` · due-diligence · service code `LND`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Consolidates soil, fill and contamination findings into a cost and risk position.

## When to use it

Once environmental and geotechnical findings return.
...
- Translate findings into cost and schedule consequences with a basis and a confidence.
- Unremediated uncertainty is carried as contingency, not as optimism.
