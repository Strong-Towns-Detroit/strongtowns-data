...
title: Due-diligence cost tracker
...
# Due-diligence cost tracker

`DD-025` · due-diligence · service code `LND`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Tracks diligence spend against authorization — money spent before a go/no-go, and therefore at risk.

## When to use it

From the first diligence commitment.
...
- Every commitment links to an authorization in `GOV-021`. Third-party diligence costs are Company costs under ICA §3.1.
- Track cumulative spend against the monthly cap, not only per transaction.
