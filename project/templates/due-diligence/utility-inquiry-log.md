...
`DD-020` · due-diligence · service code `PMT`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Chronological record of every utility inquiry, who answered, and what they said.
...
- Verbal availability confirmations are not evidence. Log them and pursue written confirmation.
