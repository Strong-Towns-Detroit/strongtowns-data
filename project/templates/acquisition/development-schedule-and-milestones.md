...
title: Development schedule and milestones
...
`ACQ-011` · acquisition · service code `EST`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

The schedule offered in the proposal, which becomes contractual under an Infill Housing Lot development agreement.

## When to use it

With the proposal; revisited before signing any development agreement.
