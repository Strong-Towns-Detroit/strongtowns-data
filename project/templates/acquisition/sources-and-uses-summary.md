...
title: Sources-and-uses summary
...
`ACQ-012` · acquisition · service code `EST`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Evidences capacity to finance and complete the project, which both pathways require.

## When to use it

With the proposal and with any lender package.
