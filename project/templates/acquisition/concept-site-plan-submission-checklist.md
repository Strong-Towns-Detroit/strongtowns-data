...
title: Concept site-plan submission checklist
...
# Concept site-plan submission checklist

`ACQ-010` · acquisition · service code `DSN`

> **Parcel-specific.** Create one copy per candidate parcel under `working/candidate-parcels/<parcel-id>/`. Do not complete this template in place.

## Purpose

Confirms the concept site plan contains what the receiving body needs to evaluate buildability and fit.
