...
title: Safety and incident records (Company-owned)
...
# Safety and incident records (Company-owned)

`CON-015` · construction · service code `INS`
...
- Receive and file. ICA §7.3 states the Contractor is not a safety officer and §7.2 makes job site safety solely the Company's responsibility. This is the sharpest boundary in the Agreement.
