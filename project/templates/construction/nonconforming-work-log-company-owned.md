...
title: Nonconforming-work log (Company-owned)
...
# Nonconforming-work log (Company-owned)

`CON-016` · construction · service code `INS`
...
- Receive and file. Determining conformance of the work to the plans is expressly outside the Contractor's role under ICA §7.3.
