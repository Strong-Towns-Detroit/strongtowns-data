...
# RFI log (Company-owned)

`CON-013` · construction · service code `INS`
...
Requests for information raised during construction.
...
- Receive and file. RFI responses come from the design professional of record.
