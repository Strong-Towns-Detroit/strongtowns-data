...
title: Punch-list tracker (Company-owned)
...
# Punch-list tracker (Company-owned)

`CON-017` · construction · service code `INS`
...
- Receive and file. Punch-list generation requires observing and evaluating the work, which ICA §7.3 excludes.
