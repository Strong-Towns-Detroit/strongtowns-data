"""Dataset and build-system models."""
...
class DatasetModel:
    """Versioned shape and validation rules for one dataset."""
    ...
    def schema(self) -> dict[str, Any]:
        ...
        # Preserve existing v1 hashes for models that do not declare enums.
...
@dataclass(frozen=True)
class DataAssetRef:
    """Immutable reference to one validated dataset snapshot."""
...
class ArtifactDescriptor:
    """Content-addressed artifact exposed by a snapshot manifest."""
