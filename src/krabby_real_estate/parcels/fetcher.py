...
# Detroit "Parcels (Current)" dataset. The older Parcels_Current service is deprecated.
ARCGIS_ITEM_ID = "3c784c118e5c4083b37038e9b38573df"
FEATURE_SERVICE = (
    "https://services2.arcgis.com/qvkbeam7Wirps6zC/arcgis/rest/services/"
    "parcel_file_current/FeatureServer/0"
)
_ARCGIS_ITEM_ID = ARCGIS_ITEM_ID  # Backwards-compatible names from the source project.
_HUB_DOWNLOAD = f"https://data.detroitmi.gov/api/download/v1/items/{ARCGIS_ITEM_ID}"
_FEATURE_SERVER = FEATURE_SERVICE
