...
from strongtowns_data.zoning.detroit_code import build_detroit_code
from strongtowns_data.zoning.detroit_permissions import add_structural_permissions
from strongtowns_data.zoning.detroit_lexicon import add_structural_lexicon
from strongtowns_data.zoning.detroit_dimensions import add_structural_dimensions
from strongtowns_data.zoning.detroit_source_provisions import add_source_provisions
from strongtowns_data.zoning.chapter_compiler import compile_chapter_package
from strongtowns_data.zoning.candidates import compile_candidates
from strongtowns_data.zoning.ordinance import parse_ordinance
from strongtowns_data.zoning.source_model import compile_source_corpus
from strongtowns_data.zoning.municode_source_model import (
    compile_municode_source_corpus,
    latest_snapshot,
)
from strongtowns_data.zoning.cross_references import compile_cross_references
from strongtowns_data.zoning.detroit_text_candidates import add_text_candidates
from strongtowns_data.zoning.applicability_scopes import compile_applicability_scopes
from strongtowns_data.zoning.detroit_overlay_rules import add_gateway_overlay_prohibitions
from strongtowns_data.zoning.detroit_formulas import add_side_setback_formulas
from strongtowns_data.zoning.detroit_conditional_permissions import (
    add_reviewed_conditional_permissions,
)
from strongtowns_data.zoning.detroit_filling_station_dimensions import (
    add_filling_station_lot_standards,
    add_filling_station_general_standards,
)
from strongtowns_data.zoning.detroit_antenna_rules import add_reviewed_antenna_rules
from strongtowns_data.zoning.detroit_compound_dimensions import add_compound_side_yards
from strongtowns_data.zoning.detroit_recreational_space import (
    add_recreational_space_formulas,
)
from strongtowns_data.zoning.detroit_special_district_dimensions import (
