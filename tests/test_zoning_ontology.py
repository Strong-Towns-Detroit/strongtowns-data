...
from strongtowns_data.zoning.ontology import (
    MZO,
    ALL_CLASSES,
    ARTICLE,
    CHAPTER,
...
from strongtowns_data.zoning.rdf_builder import (
    _permission_to_uri,
    _slugify,
...
class TestPermissionMapping:
    ...
    def test_mixed_cr(self):
        from strongtowns_data.zoning.ontology import PERM_BY_RIGHT_WITH_CONDITIONS
