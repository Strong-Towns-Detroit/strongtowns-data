...
class TestHubDownload:
    @patch("krabby_real_estate.parcels.fetcher.requests.get")
    ...
    @patch("krabby_real_estate.parcels.fetcher.time.sleep")
    @patch("krabby_real_estate.parcels.fetcher.requests.get")
...
class TestFetchGeojson:
    @patch("krabby_real_estate.parcels.fetcher._hub_download")
...
class TestQueryToGeojson:
    @patch("krabby_real_estate.parcels.fetcher.query_parcels")
