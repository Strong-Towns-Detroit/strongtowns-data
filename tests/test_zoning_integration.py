...
class TestClassifyRealTables:
    ...
    def test_article_xii_has_use_matrices(self):
        from strongtowns_data.zoning.table_parser import extract_tables_xml, classify_table
...
class TestArticleXIIUsePermissions:
    ...
    def use_records(self):
        from strongtowns_data.zoning.use_tables import extract_all_use_permissions
...
class TestArticleXIIIDimensionalStandards:
    ...
    def dim_records(self):
        from strongtowns_data.zoning.dimensional import extract_all_dimensional_standards
...
class TestArticleXVIDefinitions:
    ...
    def definitions(self):
        from strongtowns_data.zoning.definitions import extract_all_definitions
...
class TestOrchestrator:
    ...
    def test_export_round_trip(self, tmp_path):
        ...
        from strongtowns_data.zoning.ordinance import parse_ordinance, export_to_json
        import json
...
class TestCitationExtraction:
    ...
    def article_xii_sections(self):
        from strongtowns_data.zoning.document import parse_document
    ...
    def test_article_xii_has_section_citations(self, article_xii_sections):
        ...
        from strongtowns_data.zoning.citations import extract_citations
        from strongtowns_data.zoning.document import walk_sections
        from strongtowns_data.zoning.models import CitationType
...
class TestCitationGraph:
    ...
    def full_graph(self):
        ...
        from strongtowns_data.zoning.citations import build_citation_graph_from_docx
